...
import com.ipm_manager_ws.ipm_manager_app.exceptions.ErrorResponse;
...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({ActionNotFoundException.class, ReportNotFoundException.class, UserNotFoundException.class})
