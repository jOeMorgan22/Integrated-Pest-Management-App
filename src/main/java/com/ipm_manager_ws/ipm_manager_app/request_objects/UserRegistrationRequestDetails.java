...
public record UserRegistrationRequestDetails(@Username String username, @Email String email, @UsdaZone String usdaZone,
                                        @Password String password, @CustomRole String role) {
